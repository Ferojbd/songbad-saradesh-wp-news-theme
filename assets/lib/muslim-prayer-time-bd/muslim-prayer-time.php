...
class widget_muslim_prayer_time extends WP_Widget {
	function __construct() {
		parent::__construct(
			'mptb',
			__('Riptware Muslim Prayer Time BD', 'mptb' ),
			array (
	...
	function widget($args, $instance) {
		...
		echo $before_widget;
			if ( $title ){
				...
				echo '<div style="background: #1e73be; background-color:'. $mptbg_one. '; padding: 7px; color: #fff; margin-bottom:2px; border-left: 5px solid #333 ">
			<img src="'.get_bloginfo('template_url').'/assets/lib/muslim-prayer-time-bd/images/mosque-copy.png" class="no-display appear" style="width: 27px; float: left; margin-right: 12px; margin-top: -5px;"> ' . $title .  '</div>';
			} else {
				echo '<div style="background: #1e73be; background-color:' . $mptbg_one. ';  padding: 7px; color: #fff; margin-bottom:2px; border-left: 5px solid #333 ">
			<img src="'.get_bloginfo('template_url').'/assets/lib/muslim-prayer-time-bd/images/mosque-copy.png" class="no-display appear" style="width: 27px; float: left; margin-right: 12px; margin-top: -5px;">  নামাজের সময়সূচি  </div>';
			}
