...
function mptb_plugin_actions( $links ) {
	$links[] = '<a href="'.menu_page_url('muslim-prayer-time-bd/admin-settings.php', true).'">'. __('Settings','mptb') .'</a>';
	return $links;
}
...
function mptb_admin_settings() {
	wp_register_script('mptbjs', get_bloginfo('template_url').'/assets/lib/muslim-prayer-time-bd/js/mptb-admin.js', array('jquery'), '2.0');
	wp_enqueue_script('mptbjs');
	wp_enqueue_script('wp-color-picker');
	wp_enqueue_style('wp-color-picker');
	wp_enqueue_style('mptbadmin', get_bloginfo('template_url').'/assets/lib/muslim-prayer-time-bd/css/mptb-admin.css', '', '2.0');
}
add_action('admin_init', 'mptb_admin_settings');

function mptb_enqueue_scripts(){
	wp_enqueue_style('prayer-time', get_bloginfo('template_url').'/assets/lib/muslim-prayer-time-bd/css/prayer-time.css', '', '2.0');
}
...
function mptb_muslim_prayer_time() {
	...
	$mptbg_one = get_option('mptbg_one') != '' ? get_option('mptbg_one') : '#1e73be';
	...
	$prayer_name = get_option('prayer_name') != '' ? get_option('prayer_name') : '#FFFFFF';
...
<div class="muslim_prayer_time">
	...
	<div style="background: #fff; padding: 4px; box-shadow: 0px 1px 0px #dbdbdb;border-bottom: 1px solid #ccc;">
	<div style="background: #1e73be; background-color: <?php echo $mptbg_one; ?>; padding: 7px; color: #fff; margin-bottom:2px; border-left: 5px solid #333"><img src="<?php echo get_bloginfo('template_url'); ?>/assets/lib/muslim-prayer-time-bd/images/mosque-copy.png" class="no-display appear" style="width: 27px; float: left; margin-right: 12px; margin-top: -5px;">  নামাজের সময়সূচি</div>
...
wp_register_sidebar_widget('T4BMPT', 'Riptware Muslim Prayer Time', 'widget_muslim_prayer_time');
