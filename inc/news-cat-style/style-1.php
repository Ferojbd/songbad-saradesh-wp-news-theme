 <div class="col-md-6 col-sm-6 col-xs-6 divider">
            ...
            <?php 
                ...
                <div class="col-xs-12 col-md-12 menu_single">
                    <a href="<?php the_permalink();?>">
                        <div class="img"><img alt="" src="<?php the_post_thumbnail_url('large');?>"></div>
                        <div class="hl">
                ...
                <div class="col-xs-12 col-md-12 menu_single_th">
                    <div class="more_hl">
                    <?php 
                        $specific_cat_args = new WP_Query(array(
                        'post_type' => 'post',
