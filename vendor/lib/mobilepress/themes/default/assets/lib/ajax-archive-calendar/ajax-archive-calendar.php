...
class ajax_ac_widget extends WP_Widget {
	...
	function widget($args, $instance) {
		...
		<div id="ajax_ac_widget">
            ...
            <div class="aj-loging" style="left: 49%;position: absolute;top: 50%; display:none"><img src="<?php $url = bloginfo ('template_url');
			echo $url . '/assets/lib/ajax-archive-calendar/loading.gif'; ?>" /></div>
